 ...
 * update_mem_per.java
 *
 * Created on Sep 24, 2010, 12:50:41 PM
 */
 ...
 * @author Agarwal's
 */
public class update_mem_per extends javax.swing.JFrame {

    /** Creates new form update_mem_per */
    public update_mem_per() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("UPDATE MEMBER  PERSONAL");
        ...
        UpdateCmdButton.setForeground(new java.awt.Color(0, 102, 102));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(66, 66, 66)
                                .addComponent(ClearCmdButton, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE))
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        try {
            ...
            String sql="select * from memPERSONAL where memberid="+mid;
    ...
    private void UpdateCmdButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateCmdButtonActionPerformed
        ...
        if (ans == JOptionPane.YES_OPTION) {
            try {
                ...
                String sql="update mempersonal set name='"+(a)+"',sex='"+(b)+"',age="+(c)+",address='"+(d)+"',phone="+(e)+",doj='"+(f)+"' where memberid="+(h)+"";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_mem_per().setVisible(true);
            }
        });
    }
