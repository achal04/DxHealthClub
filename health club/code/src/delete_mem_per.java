 ...
 * delete_mem_per.java
 *
 * Created on Sep 24, 2010, 12:44:17 PM
 */
 ...
 * @author Agarwal's
 */
public class delete_mem_per extends javax.swing.JFrame {

    /** Creates new form delete_mem_per */
    public delete_mem_per() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELETE MEMBER PERSONAL");
        ...
        jLabel8.setText("JOINIG DATE");

        DeleteCmdButton.setFont(new java.awt.Font("Times New Roman", 1, 18));
        DeleteCmdButton.setForeground(new java.awt.Color(153, 51, 0));
    ...
    private void DeleteCmdButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteCmdButtonActionPerformed
        ...
        if (ans == JOptionPane.YES_OPTION) {
            try {
                ...
                String sql="delete from mempersonal where memberid="+(a)+"";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_mem_per().setVisible(true);
            }
        });
    }
